                    ...
                    <ModalBody>
                        ...
                        <div className="p-1">
                            <ul className="my-4 space-y-3">
                                ...
                                <li>
                                    <button className="flex items-center w-full p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white" disabled>
