            ...
            >
                ...
                <ModalContent>
                    ...
                    <ModalBody>
                        ...
                        { error && 
                            <p className={`mt-4 text-md text-red-600 dark:text-red-400`}>
                                {`Error: ${error}`}
                            </p>
                        }
